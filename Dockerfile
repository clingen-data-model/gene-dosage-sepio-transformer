...
COPY --from=builder /usr/src/app/target/uberjar/gene-dosage-sepio-transformer.jar /app/gene-dosage-sepio-transformer.jar

EXPOSE 8888

CMD ["java", "-jar", "/app/gene-dosage-sepio-transformer.jar"]